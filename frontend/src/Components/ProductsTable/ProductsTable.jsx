        ...
        <table className="products-table">
          <thead>
            <tr className="products-table-heading-tr">
              <th className="product-heading-th">عکس</th>
              <th className="product-heading-th">اسم</th>
              <th className="product-heading-th">قیمت</th>
              <th className="product-heading-th">موجودی</th>
            </tr>
          </thead>
          {allProducts.map((product) => (
            <tbody key={product.id}>
              <tr className="products-table-tr">
                ...
                <td className="product-table-td">{product.price} تومان</td>
